...
freader = list(csv.reader(flow))			# sets the file that is read to a list of lists													# closes the file once the reader is done
x = 1	
y = 0								    # sets x to 1 because we don't want the first row of the csv                                      # sets y to 0 so we can compare yearChoice with index0 of freader
